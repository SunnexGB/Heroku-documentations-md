---
{"dg-publish":true,"permalink":"/extended-documentation/decorators/","dgShowLocalGraph":true,"dgEnableSearch":true,"dg-note-properties":{}}
---
...
> [!info] Важно
> Подробнее об циклах в [[Extended documentation/Loops\| Циклах]]
...
- `@loader.inline_handler()` - помечает [[Extended documentation/Inline#Инлайн (@bot ...)\|инлайн хендлер]] (`@heroku_..._bot <method>`)
...
> [!info] Важно
> Подробнее о вотчерах в [[Extended documentation/Watchers\|вотчерах]]
...
[[Extended documentation/Decorators\|<=]] [[Extended documentation/Home\|На главную]] [[Extended documentation/Watchers\|=>]]