---
{"dg-publish":true,"permalink":"/extended-documentation/lookup-and-invoke/","dgShowLocalGraph":true,"dgEnableSearch":true,"dg-note-properties":{}}
---
...
> [!warning] Важно
> Аннотация в кавычках (`"Literal[False] | Module | Library"`) обязательна. Module и Library импортируются под `TYPE_CHECKING`, чтобы loader не нашёл их раньше твоего класса. Подробнее об этом - в [[Extended documentation/Quickstart#TYPE_CHECKING - импорт типов\|основаях разработки]]
...
[[Extended documentation/Lookup & Invoke\|<=]] [[Extended documentation/Home\|На главную]] [[Extended documentation/Lookup & Invoke\|=>]]
