---
{"dg-publish":true,"permalink":"/extended-documentation/inline/","dgShowLocalGraph":true,"dgEnableSearch":true,"dg-note-properties":{}}
---
...
> [!info] Важно
>  `utils.get_args_raw` описан в [[Extended documentation/Utils#Работа с сообщениями\|Вспомогателных функциях]]
# Списки
...
> [!note] Важно
> Эти декораторы описаны в [[Extended documentation/Decorators#Разрешения для команд\|Декораторы]]
...
[[Extended documentation/Inline\|<=]] [[Extended documentation/Home\|На главную]] [[Extended documentation/Rich Message\|=>]]