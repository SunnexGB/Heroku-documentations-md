---
{"dg-publish":true,"permalink":"/extended-documentation/loops/","dgEnableSearch":true,"dg-note-properties":{}}
---
...
> [!info] Note
> `on_unload` описан в [[Extended_documentation/Quickstart#Документация по структуре\|основах разработки]]
...
[[Extended_documentation/Loops\|<=]] [[Extended_documentation/Home\|На главную]] [[Extended_documentation/Raw Handler\|=>]]
